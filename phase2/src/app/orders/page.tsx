    ...
    return (
        <div className="min-h-screen bg-[#0a0a0c] text-white">
            <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
                <h1 className="text-3xl font-bold tracking-tight text-white mb-8">My Orders</h1>
                ...
                {orders.length === 0 ? (
                    <div className="text-center py-24 rounded-2xl bg-white/5 border border-white/10">
                        ...
                        <p className="mt-2 text-gray-400">Looks like you haven&apos;t purchased anything.</p>
                        <div className="mt-6">
                            <a href="/shop" className="text-indigo-400 hover:text-indigo-300 font-medium">Browse Shop &rarr;</a>
                        </div>
                    </div>
                ) : (
