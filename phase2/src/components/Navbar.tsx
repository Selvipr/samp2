                ...
                <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    {user ? (
                        <div className="flex items-center gap-4">
                            <Link href="/cart" className="relative group text-gray-400 hover:text-white transition-colors">
                            ...
                            <Link href="/profile" className="relative group text-gray-400 hover:text-white transition-colors">
